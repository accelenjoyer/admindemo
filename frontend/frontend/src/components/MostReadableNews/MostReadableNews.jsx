                ...
                {articles.slice(0, 4).map((article, i) => (
                    <div key={article._id || i} className="news-box">
                        <div className="top-block">
                            ...
                            <div className="text-container"> {/* Новый контейнер */}
                                ...
                                <div className="main-text">
                                    <p>{article.content}</p>
                                   <p style={{marginTop:"12px",textTransform:"uppercase",fontSize: "10px"}}> Автор: {article.author} {formatDate(article.date)} {article.views} просмотров</p>
                                </div>
                            </div>
                        </div>
