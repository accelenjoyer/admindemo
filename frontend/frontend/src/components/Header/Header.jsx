...
const Header = ({ articles, searchValue, onSearchChange }) => {
    ...
    // Для отображения результатов поиска можно ограничить до 4 штук или по желанию
                        ...
                        {searchbarOpen && (
                            <>
                                {searchValue ? (
                                        ...
                                        searchResults.map(article => (
                                            <div key={article._id} className="search-item">
                                                ...
                                                <div className="article-info">
                                                    ...
                                                    <span>{article.views} {getViewsWord(article.views)}</span>
                                                </div>
                                            </div>
                                        ))
                                    ) : (
                                    ...
                                    // Показываем 4 рандомные статьи при пустом поиске
                                    articles
